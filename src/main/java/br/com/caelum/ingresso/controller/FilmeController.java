...
import br.com.caelum.ingresso.client.DetalhesDoFilme;
...
public class FilmeController {
    ...
    public ModelAndView detalhes(@PathVariable("id") Integer filmeId) {
    	...
    	Optional<DetalhesDoFilme> optionalDetalhes = client.request(filme, DetalhesDoFilme.class);
    	
    	List<Sessao> sessoesDoFilme = sessaoDao.buscaSessoesDoFilme(filme);
    	
    	modelAndView.addObject("sessoes", sessoesDoFilme);
    	modelAndView.addObject("detalhes", optionalDetalhes.orElse(new DetalhesDoFilme()));
